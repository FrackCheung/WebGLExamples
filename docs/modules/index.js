...
const render = () => {
    ...
    // 立方体
    const cubeModel = MatrixService.multiply(MatrixService.cubeRotate(degree), MatrixService.translate(0.0, 0.6, 0.0));
    ...
    // 立方体
    const sphereModel = MatrixService.multiply(MatrixService.rotateY(degree), MatrixService.translate(0.0, -0.2, 0.0));
